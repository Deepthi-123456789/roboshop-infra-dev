...
data "aws_ssm_parameter" "mongodb_sg_ids" {
  name = "/${var.project_name}/${var.environment}/mongodb_sg_ids"
} 
data "aws_ssm_parameter" "redis_sg_ids" {
  name = "/${var.project_name}/${var.environment}/redis_sg_ids"
} 
...
data "aws_ssm_parameter" "rabbitmq_sg_ids" {
  name = "/${var.project_name}/${var.environment}/rabbitmq_sg_ids"
} 
