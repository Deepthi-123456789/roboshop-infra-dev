...
module "web" {
  ...
  vpc_security_group_ids = [data.aws_ssm_parameter.web_sg_ids.value]
...
##provisining with provisioner using ansible
...
resource "aws_lb_listener_rule" "web" {
  ...
  condition {
    host_header {
      values = ["${var.tags.Component}-${var.environment}.pjdevops.online"]
    }
  }
}
